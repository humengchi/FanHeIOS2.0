...
//
+ (NSData *)dataFromBase64String:(NSString *)aString dataUsingEncoding:(NSStringEncoding)encoding
{
...
{
    return [self base64EncodedString:NSASCIIStringEncoding];
}
...
- (NSString *)base64EncodedString:(NSStringEncoding)encoding
{
    ...
    NSString *result =[[NSString alloc] initWithBytes:outputBuffer length:outputLength encoding:encoding];
    free(outputBuffer);
    return result;
}
...
{
    return [self base64decodedString:NSASCIIStringEncoding];
}
...
- (NSData *)base64decodedData
{
    ...
    NSData *adata = [[NSData alloc] initWithBytes:outputBuffer length:outputLength] ;
...
- (char*)base64decodeChar:(int *)outlen
{
    size_t outputLength;
    char *outputBuffer =    NewBase64Decode([self bytes], [self length], &outputLength);
