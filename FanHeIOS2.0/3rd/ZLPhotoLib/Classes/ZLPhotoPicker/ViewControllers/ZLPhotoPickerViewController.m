...
- (void) createNavigationController{
    ...
    groupVc.topShowPhotoPicker = self.topShowPhotoPicker;
    CRNavigationController *nav = [[CRNavigationController alloc] initWithRootViewController:groupVc];
    [nav.navigationBar setBarTintColor:kDefaultColor];
