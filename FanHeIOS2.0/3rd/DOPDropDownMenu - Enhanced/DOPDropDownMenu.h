...
@interface DOPDropDownMenu : UIView <TagSearchViewDelegate,UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic, assign) NSInteger currentIndex;       //当前选中的column
@property (nonatomic, assign) CGFloat menHeigth;

//add by xiyang
@property (nonatomic, copy) void(^finishedBlock)(DOPIndexPath *indexPath);//回收回调
@property (nonatomic, copy) void(^finishedChangeBlock)(NSInteger col,NSInteger pow);//回收回调
