...
+ (void)initialize
{
    ...
    recordView.voiceMessageAnimationImages = @[@"icon_yy_01",@"icon_yy_02",@"icon_yy_03",@"icon_yy_04",@"icon_yy_05",@"icon_yy_06",@"icon_yy_07",@"icon_yy_08"];
     recordView.upCancelText = @"发送";
     recordView.loosenCancelText = @"取消";
