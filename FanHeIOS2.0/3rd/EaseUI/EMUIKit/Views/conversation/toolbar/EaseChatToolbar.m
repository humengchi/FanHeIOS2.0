...
//    [self addSubview:_backgroundImageView];
    ...
    _toolbarView.backgroundColor = HEX_COLOR(@"F8F8F8");//[UIColor clearColor];
...
//    _inputTextView.placeHolder = NSEaseLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    ...
    _inputTextView.backgroundColor = WHITE_COLOR;//[UIColor clearColor];
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"icon_dh_keyboard"] forState:UIControlStateSelected];
    [styleChangeButton setImage:[UIImage imageNamed:@"icon_dh_voice"] forState:UIControlStateNormal];
    ...
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"bg_voice_off"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"bg_voice_on"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"icon_dh_expression"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"icon_dh_expression"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"icon_dh_expression"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"icon_dh_more"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"icon_dh_more"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"icon_dh_keyboard"] forState:UIControlStateSelected];
