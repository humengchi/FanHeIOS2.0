...
@implementation EaseBubbleView (Activity)
- (void)_setupActivityBunamicbbleMarginConstraints:(id<IMessageModel>)model{
    if (model.isSender) {
...
- (void)setupActivityBubbleView:(id<IMessageModel>)model{
    ...
    self.countLabel =  [[UILabel alloc] initWithFrame:CGRectMake(14, 46, 200, 16)];
    ...
    self.lineView = [[UIView alloc]initWithFrame:CGRectMake(16, 36, imageView.frame.size.width - 32, 0.5)];
    ...
    [self _setupActivityBunamicbbleMarginConstraints:model];
