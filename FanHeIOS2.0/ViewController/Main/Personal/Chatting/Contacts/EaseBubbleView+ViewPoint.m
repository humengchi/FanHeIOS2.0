...
@implementation EaseBubbleView (ViewPoint)
- (void)_setupViewPointBunamicbbleMarginConstraints:(id<IMessageModel>)model{
    if (model.isSender) {
...
{
    [self _setupViewPointBunamicbbleMarginConstraints:model];
}
