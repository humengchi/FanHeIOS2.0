...
typedef void(^PublushViewpointSuccess)();

typedef NS_ENUM(NSUInteger, EditotType) {
    EditotType_Topic,
    EditotType_Viewpoint,
    EditotType_Activity,
};
...
@property (nonatomic, strong) ViewpointDetailModel *vpdModel;

@property (nonatomic, strong) void(^atPerson)(ContactsModel *model);

@property (nonatomic, strong) PublushViewpointSuccess publushViewpointSuccess;

@property (nonatomic, assign) EditotType type;

@property (nonatomic, strong) void(^activityIntroduction)(NSString *introStr);
